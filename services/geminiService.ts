...
// Using gemini-3-pro-preview for best reasoning capabilities on math/STEM tasks
const MODEL_NAME = 'gemini-3-pro-preview';

const SYSTEM_INSTRUCTION = `You are MathGenius, an advanced academic AI tutor designed to solve math problems with high precision and perfect formatting.
